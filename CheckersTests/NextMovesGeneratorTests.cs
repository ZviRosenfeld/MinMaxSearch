...
namespace CheckersTests
{
    ...
    public class NextMovesGeneratorTests
    {
        ...
        public void MinMoveTest()
        {
            ...
            var expectedBoard = Utils.GetEmptyBoard(3);
        ...
        public void MinMoveGetsKingTest()
        {
            ...
            var expectedBoard = Utils.GetEmptyBoard(2);
        ...
        {
            var board = Utils.GetEmptyBoard(4);
        ...
        public void MinDoubleJumpTest()
        {
            ...
            var expectedBoard1 = Utils.GetEmptyBoard(5);
            expectedBoard1[2, 2] = CheckerPiece.MinChecker;
            expectedBoard1[1, 3] = CheckerPiece.MaxKing;
            Assert.IsTrue(Utils.AreEquale(expectedBoard1, nextMove[0].GetBoard()), "Got board" + Environment.NewLine + nextMove[0]);

            var expectedBoard2 = Utils.GetEmptyBoard(5);
            expectedBoard2[0, 4] = CheckerPiece.MinKing;
            Assert.IsTrue(Utils.AreEquale(expectedBoard2, nextMove[1].GetBoard()), "Got board" + Environment.NewLine + nextMove[1]);
        }
        ...
        public void KingMovesTest(Player player)
        {
            ...
            expectedBoard = Utils.GetEmptyBoard(3);
        ...
        public void KingJumpsTest(Player player)
        {
            ...
            var expectedBoard = Utils.GetEmptyBoard(5);
            ...
            expectedBoard = Utils.GetEmptyBoard(5);
            PlacePiecesToJump(player, expectedBoard);
